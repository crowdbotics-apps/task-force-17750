"""task_force_17750 URL Configuration
...
admin.site.site_header = "Task Force"
admin.site.site_title = "Task Force Admin Portal"
admin.site.index_title = "Task Force Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Task Force API",
        default_version="v1",
        description="API documentation for Task Force App",
    ),
    public=True,
